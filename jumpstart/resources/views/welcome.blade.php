              ...
              <div>
                ...
                <div>
                  ...
                  <div class="mt-8 flex gap-x-4 sm:justify-center">
                    <a href="#" class="inline-block rounded-lg px-10 py-1.5 text-base font-semibold leading-7 text-white ring-1 ring-white hover:ring-yellow-500">
                      Get Started
              ...
              <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl text-gray-800 uppercase mb-6">Our Product</h1>
                ...
                <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-3 ">
                  <div class="shadow-lg pb-4 bg-white rounded-xl mt-6">
                    <div class="flex justify-center md:justify-center my-3 ">
                      <img src="{{ asset('images/product.jpg') }}" alt="product" class="h-72 w-96 rounded-t-xl">
                    </div>
